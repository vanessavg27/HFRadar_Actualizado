...
python3 Filtrado.py -f 2.7221646392718 -path $1 -code 1 -C $2 -date $3 -R 1
python3 Filtrado.py -f 2.7221712982282 -path $1 -code 2 -C $2 -date $3 -R 1

python3 Filtrado.py -f 3.64990234375   -path $1 -code 0 -C $2 -date $3 -R 1
python3 Filtrado.py -f 3.6499056732282 -path $1 -code 1 -C $2 -date $3 -R 1
python3 Filtrado.py -f 3.6498990142718 -path $1 -code 2 -C $2 -date $3 -R 1
